...
#==============================================================================# 
                    ...
                    A = hasil.text
                    line.sendMessage(msg.to, A)
                elif text[:22].lower() == "Bc ":
		            bc = msg.text.replace("Bc ","")
		            gid = line.getGroupIdsJoined()
		            for i in gid:
			            line.sendText(i,"🔒[ข้อความนี้เป็นข้อความอัตโนมัติ]\n\n"+bc+"\n\n👥สนใจติดต่อสอบถาม 📲: line://ti/p/~aec4455
#==============================================================================#   
